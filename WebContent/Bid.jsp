...
<form class="form-inline my-2 my-lg-2 ml-2" action="BidServlet" method="post">
	Enter your amount : <input type="number" name="amount"><br>
	<input type="hidden" value="${param.Project_id}" name="Project_id">
